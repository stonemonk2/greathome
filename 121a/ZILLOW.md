# Relist kit — 121 Santa Fe Ave, Unit A

Everything needed to fix the live Zillow ad and post to Craigslist and Facebook.
Copy-paste ready.
...
**1. Delete all 40 photos on the Zillow listing.** Every one is from the 2006
remodel. The captions currently say *"2006 remodel: all new kitchen and new
floors throughout"* and *"A previous tenant decorated this area very nicely!"*
Prospects are being shown a twenty-year-old kitchen at $2,600/mo. This alone
explains the silence since June.

**2. Check whether the May Apartments.com ad is still live.** It was posted at
$2,500 with old photos, deliberately above market, to keep the unit quiet during
the renovation. If it is still up you have two stale listings at two different
prices. Kill or update it before posting anywhere new.
...
|---|---|---|
| Flooring | Hardwood | **Vinyl** — Zillow has no "laminate" option; correct it in the description |
...
**Add these amenities:** garbage disposal, range hood, stainless appliances,
granite counters, recessed lighting, patio/garden, storage. Double-pane windows
is already set.

### One accuracy note

The floor is **12mm AC5 laminate** (Republic Floor, North Forest), not luxury
vinyl plank — the invoice calls it LVP but the spec says laminate. AC5 is the
top abrasion rating, so this is not a downgrade to admit; it is a better number
than most renovated rentals can quote. Just do not print "luxury vinyl plank."

---

## Listing description — Zillow / Apartments.com
...
> appliances, new bathroom, new windows, new roof, new flooring throughout.
> AT&T Fiber ready.
>
...
Also post it to the **Point Richmond** and **Richmond CA** community groups —
they carry real local traffic and cost nothing.
...
| Channel | Cost | Notes |
|---|---|---|
| **Zillow** | ~$10/wk | Syndicates to Trulia and HotPads automatically — three sites, one listing |
| **Craigslist** | ~$5 | Still heavily used for Bay Area rentals. Allows links. Repost every 48h |
| **Facebook Marketplace** | free | Plus the Point Richmond community groups |
| Apartments.com | paid | Built for large complexes, priced accordingly. Hold in reserve |

Redfin's rental inventory comes largely from partner feeds, so there is no
useful owner-posted route there.

---

## Photo order for the listing

Zillow leads with the first photo everywhere — search results, saved searches,
the share card. Put the strongest shot first and do not bury the kitchen.

1. Living room hero (B1)
2. Kitchen hero (C1)
3. Granite breakfast bar
4. Kitchen, reverse angle
5. Bathroom, from the doorway
6. Office / flex room
7. Bedroom
8. Living room, second angle
9. Granite and workstation sink
10. Range and hood
11. Building exterior / front gate
12. Patio
13–20. Closets, windows, details, laundry shed

Label every virtually staged image **"Virtually staged"** in its caption.
Zillow's listing policy requires the disclosure and prospects expect staging —
what they resent is discovering it.

---

## After you relist

Give it **14 days** before touching the price. You have never actually tested
$2,600 with real photos, so the silence to date is not market data.

If inquiries are still thin after two weeks, drop to **$2,495** — not $2,550.
$2,500 is the most common max-price filter renters set, and at $2,600 you are
invisible to everyone using it. At $2,495 you become the best unit at the top of
a much larger pool.
